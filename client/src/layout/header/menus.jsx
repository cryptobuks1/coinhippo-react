export const menus = [
	{
		...
		subMenu: [
			...
			[{
				title: 'Explorers',
				subMenu: [
					{ path: 'https://explorers.coinhippo.io/eth-mainnet'/*'/explorer/ethereum'*/, target: '_blank', rel: 'noopener noreferrer', title: 'Ethereum', chain_id: '1', network: 'mainnet', unit: 'Ether', logo_url: 'https://www.covalenthq.com/static/images/icons/display-icons/ethereum-eth-logo.png', altExplorerUrl: 'https://etherscan.io/address/{address}' },
					{ path: 'https://explorers.coinhippo.io/bsc-mainnet'/*'/explorer/bsc'*/, target: '_blank', rel: 'noopener noreferrer', title: 'BSC', chain_id: '56', network: 'mainnet', unit: 'BNB', logo_url: 'https://www.covalenthq.com/static/images/icons/display-icons/binance-coin-bnb-logo.png', altExplorerUrl: 'https://bscscan.com/address/{address}' },
					{ path: 'https://explorers.coinhippo.io/matic-mainnet'/*'/explorer/matic'*/, target: '_blank', rel: 'noopener noreferrer', title: 'Polygon', chain_id: '137', network: 'mainnet', unit: 'MATIC', logo_url: 'https://www.covalenthq.com/static/images/icons/display-icons/polygon-matic-logo.png', altExplorerUrl: 'https://polygonscan.com/address/{address}' },
					{ path: 'https://explorers.coinhippo.io/avalanche-mainnet'/*'/explorer/avalanche'*/, target: '_blank', rel: 'noopener noreferrer', title: 'Avalanche', chain_id: '43114', network: 'mainnet', unit: 'AVAX', gas_unit: 'nAVAX', logo_url: 'https://www.covalenthq.com/static/images/icons/display-icons/avalanche-avax-logo.png', altExplorerUrl: 'https://avascan.info/blockchain/c/address/{address}' },
					{ path: 'https://explorers.coinhippo.io/fantom-mainnet'/*'/explorer/fantom'*/, target: '_blank', rel: 'noopener noreferrer', title: 'Fantom', chain_id: '250', network: 'mainnet', unit: 'FTM', logo_url: 'https://www.covalenthq.com/static/images/icons/display-icons/fantom-ftm-logo.png', altExplorerUrl: 'https://ftmscan.com/address/{address}' },
					{ path: 'https://explorers.coinhippo.io/rsk-mainnet'/*'/explorer/rsk'*/, target: '_blank', rel: 'noopener noreferrer', title: 'RSK', chain_id: '30', network: 'mainnet', unit: 'RBTC', logo_url: 'https://www.covalenthq.com/static/images/icons/display-icons/rsk-mainnet-logo.png', altExplorerUrl: 'https://explorer.rsk.co/address/{address}', isHideFromMenu: true },
					{ path: 'https://explorers.coinhippo.io/arbitrum-mainnet'/*'/explorer/arbitrum'*/, target: '_blank', rel: 'noopener noreferrer', title: 'Arbitrum', chain_id: '42161', network: 'mainnet', unit: 'Ether', logo_url: 'https://www.covalenthq.com/static/images/icons/display-icons/arbitrum-mainnet-logo.png', altExplorerUrl: 'https://explorer.arbitrum.io/address/{address}', isHideFromMenu: true },
					{ path: 'https://explorers.coinhippo.io/moonbeam-moonriver'/*'/explorer/moonbeam-moonriver'*/, target: '_blank', rel: 'noopener noreferrer', title: 'Moonbeam', altTitle: 'Moonriver', chain_id: '1285', network: 'moonriver', unit: 'MOVR', logo_url: 'https://www.covalenthq.com/static/images/icons/display-icons/moonbeam-logo.png', altExplorerUrl: 'https://moonriver.subscan.io/account/{address}' },
					{ path: 'https://explorers.coinhippo.io/moonbeam-moonbase-alpha'/*'/explorer/moonbeam-moonbase'*/, target: '_blank', rel: 'noopener noreferrer', title: 'Moonbeam', chain_id: '1287', network: 'moonbase-alpha', unit: 'DEV', logo_url: 'https://www.covalenthq.com/static/images/icons/display-icons/moonbeam-logo.png', altExplorerUrl: 'https://moonbase.subscan.io/account/{address}' },
				],
				isReload: true
			},
			{
