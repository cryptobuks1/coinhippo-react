                          ...
                          <Row>
                            <Col lg="3" md="6" sm="6" xs={width >= 375 ? 6 : 12}>
                              ...
                              {data.market_data && data.market_data.market_cap && typeof data.market_data.market_cap[currency] === 'number' && data.market_data.market_cap[currency] > 0 ?
                                <div className={`h3 ${width > 991 && numberOptimizeDecimal(numeral(data.market_data.market_cap[currency]).format('0,0') !== 'NaN' ? numeral(data.market_data.market_cap[currency]).format('0,0') : data.market_data.market_cap[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width <= 1200 ? 11 : 15) + (currencyData && currencyData.symbol ? 3 : 0) ? `f-${width <= 1200 ? 10 : 12} f-w-500 ` : width <= 575 && numberOptimizeDecimal(numeral(data.market_data.market_cap[currency]).format('0,0') !== 'NaN' ? numeral(data.market_data.market_cap[currency]).format('0,0') : data.market_data.market_cap[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width >= 414 ? 18 : 14) + (currencyData && currencyData.symbol ? 3 : 0) ? width <= 375 ? 'f-12 ' : 'f-12 ' : 'f-16 '}mt-2`}>{currencyData && currencyData.symbol}{numberOptimizeDecimal(numeral(data.market_data.market_cap[currency]).format('0,0') !== 'NaN' ? numeral(data.market_data.market_cap[currency]).format('0,0') : data.market_data.market_cap[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{!(currencyData && currencyData.symbol) && (<> {currency.toUpperCase()}</>)}</div>
                                :
                            ...
                            <Col lg="3" md="6" sm="6" xs={width >= 375 ? 6 : 12} className={`mt-${width >= 375 ? 0 : 3} mt-sm-0`}>
                              ...
                              {data.market_data && data.market_data.fully_diluted_valuation && typeof data.market_data.fully_diluted_valuation[currency] === 'number' ?
                                <div className={`h3 ${width > 991 && numberOptimizeDecimal(numeral(data.market_data.fully_diluted_valuation[currency]).format('0,0') !== 'NaN' ? numeral(data.market_data.fully_diluted_valuation[currency]).format('0,0') : data.market_data.fully_diluted_valuation[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width <= 1200 ? 11 : 15) + (currencyData && currencyData.symbol ? 3 : 0) ? `f-${width <= 1200 ? 10 : 12} f-w-500 ` : width <= 575 && numberOptimizeDecimal(numeral(data.market_data.fully_diluted_valuation[currency]).format('0,0') !== 'NaN' ? numeral(data.market_data.fully_diluted_valuation[currency]).format('0,0') : data.market_data.fully_diluted_valuation[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width >= 414 ? 18 : 14) + (currencyData && currencyData.symbol ? 3 : 0) ? width <= 375 ? 'f-12 ' : 'f-12 ' : 'f-16 '}mt-2`}>{currencyData && currencyData.symbol}{numberOptimizeDecimal(numeral(data.market_data.fully_diluted_valuation[currency]).format('0,0') !== 'NaN' ? numeral(data.market_data.fully_diluted_valuation[currency]).format('0,0') : data.market_data.fully_diluted_valuation[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{!(currencyData && currencyData.symbol) && (<> {currency.toUpperCase()}</>)}</div>
                                :
                            ...
                            <Col lg="3" md="6" sm="6" xs={width >= 375 ? 6 : 12} className="mt-3 mt-lg-0">
                              ...
                              {data.market_data && data.market_data.total_volume && typeof data.market_data.total_volume[currency] === 'number' ?
                                <div className={`h3 ${width > 991 && numberOptimizeDecimal(numeral(data.market_data.total_volume[currency]).format('0,0') !== 'NaN' ? numeral(data.market_data.total_volume[currency]).format('0,0') : data.market_data.total_volume[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width <= 1200 ? 10 : 14) + (currencyData && currencyData.symbol ? 3 : 0) ? `f-${width <= 1200 ? 10 : 12} f-w-500` : width <= 575 && numberOptimizeDecimal(numeral(data.market_data.total_volume[currency]).format('0,0') !== 'NaN' ? numeral(data.market_data.total_volume[currency]).format('0,0') : data.market_data.total_volume[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width >= 414 ? 15 : 12) + (currencyData && currencyData.symbol ? 3 : 0) ? width <= 375 ? 'f-12 ' : 'f-12 ' : 'f-16 '}mt-2`} style={{ marginTop: '9.2px' }}>{currencyData && currencyData.symbol}{numberOptimizeDecimal(numeral(data.market_data.total_volume[currency]).format('0,0') !== 'NaN' ? numeral(data.market_data.total_volume[currency]).format('0,0') : data.market_data.total_volume[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{!(currencyData && currencyData.symbol) && (<> {currency.toUpperCase()}</>)}</div>
                                :
                                <div className="h3 f-16 mt-2">{"-"}</div>
                              }
                            </Col>
                            <Col lg="3" md="6" sm="6" xs={width >= 375 ? 6 : 12} className="mt-3 mt-lg-0">
                              ...
                              {data.market_data && data.market_data && typeof data.market_data.circulating_supply === 'number' && data.market_data.circulating_supply > 0 ?
                                <div className={`h3 ${width > 991 && numberOptimizeDecimal(numeral(data.market_data.circulating_supply).format('0,0') !== 'NaN' ? numeral(data.market_data.circulating_supply).format('0,0') : data.market_data.circulating_supply.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width <= 1200 ? 13 : 15) ? `f-${width <= 1200 ? 10 : 12} f-w-500 ` : width <= 575 && numberOptimizeDecimal(numeral(data.market_data.circulating_supply).format('0,0') !== 'NaN' ? numeral(data.market_data.circulating_supply).format('0,0') : data.market_data.circulating_supply.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width >= 414 ? 15 : 12) + (currencyData && currencyData.symbol ? 3 : 0) ? width <= 375 ? 'f-12 ' : 'f-12 ' : 'f-16 '}mt-2`}>{numberOptimizeDecimal(numeral(data.market_data.circulating_supply).format('0,0') !== 'NaN' ? numeral(data.market_data.circulating_supply).format('0,0') : data.market_data.circulating_supply.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{data.symbol && (<> {data.symbol.toUpperCase()}</>)}</div>
                                :
                                <div className="h3 f-16 mt-2">{"N/A"}</div>
                              }
                            ...
                            {data.market_data && data.market_data.mcap_to_tvl_ratio && typeof data.market_data.mcap_to_tvl_ratio === 'number' && data.market_data.mcap_to_tvl_ratio > 0 && (
                              <Col lg="3" md="6" sm="6" xs={width >= 375 ? 6 : 12} className="mt-3">
                                ...
                                <div className={`h3 ${width > 991 && numberOptimizeDecimal(numeral(data.market_data.mcap_to_tvl_ratio).format('0,0.00') !== 'NaN' ? numeral(data.market_data.mcap_to_tvl_ratio).format('0,0.00') : data.market_data.mcap_to_tvl_ratio.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 10 })).length >= (width <= 1200 ? 11 : 15) ? `f-${width <= 1200 ? 10 : 12} f-w-500 ` : width <= 575 && numberOptimizeDecimal(numeral(data.market_data.mcap_to_tvl_ratio).format('0,0.00') !== 'NaN' ? numeral(data.market_data.mcap_to_tvl_ratio).format('0,0.00') : data.market_data.mcap_to_tvl_ratio.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 10 })).length >= (width >= 414 ? 18 : 14) ? width <= 375 ? 'f-12 ' : 'f-12 ' : 'f-16 '}mt-2`}>{numberOptimizeDecimal(numeral(data.market_data.mcap_to_tvl_ratio).format('0,0.00') !== 'NaN' ? numeral(data.market_data.mcap_to_tvl_ratio).format('0,0.00') : data.market_data.mcap_to_tvl_ratio.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 10 }))}</div>
                              </Col>
                            )}
                            {data.market_data && data.market_data.fdv_to_tvl_ratio && typeof data.market_data.fdv_to_tvl_ratio === 'number' && data.market_data.fdv_to_tvl_ratio > 0 && (
                              <Col lg="3" md="6" sm="6" xs={width >= 375 ? 6 : 12} className="mt-3">
                                ...
                                <div className={`h3 ${width > 991 && numberOptimizeDecimal(numeral(data.market_data.fdv_to_tvl_ratio).format('0,0.00') !== 'NaN' ? numeral(data.market_data.fdv_to_tvl_ratio).format('0,0.00') : data.market_data.fdv_to_tvl_ratio.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 10 })).length >= (width <= 1200 ? 11 : 15) ? `f-${width <= 1200 ? 10 : 12} f-w-500 ` : width <= 575 && numberOptimizeDecimal(numeral(data.market_data.fdv_to_tvl_ratio).format('0,0.00') !== 'NaN' ? numeral(data.market_data.fdv_to_tvl_ratio).format('0,0.00') : data.market_data.fdv_to_tvl_ratio.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 10 })).length >= (width >= 414 ? 18 : 14) ? width <= 375 ? 'f-12 ' : 'f-12 ' : 'f-16 '}mt-2`}>{numberOptimizeDecimal(numeral(data.market_data.fdv_to_tvl_ratio).format('0,0.00') !== 'NaN' ? numeral(data.market_data.fdv_to_tvl_ratio).format('0,0.00') : data.market_data.fdv_to_tvl_ratio.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 10 }))}</div>
                              </Col>
                            )}
                            {data.market_data && data.market_data.total_value_locked && typeof data.market_data.total_value_locked.usd === 'number' && data.market_data.total_value_locked.usd > 0 && (
                              <Col lg="3" md="6" sm="6" xs={width >= 375 ? 6 : 12} className="mt-3">
                                ...
                                <div className={`h3 ${width > 991 && numberOptimizeDecimal(numeral(data.market_data.total_value_locked.usd).format('0,0') !== 'NaN' ? numeral(data.market_data.total_value_locked.usd).format('0,0') : data.market_data.total_value_locked.usd.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width <= 1200 ? 11 : 15) + 3 ? `f-${width <= 1200 ? 10 : 12} f-w-500 ` : width <= 575 && numberOptimizeDecimal(numeral(data.market_data.total_value_locked.usd).format('0,0') !== 'NaN' ? numeral(data.market_data.total_value_locked.usd).format('0,0') : data.market_data.total_value_locked.usd.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 })).length >= (width >= 414 ? 18 : 14) + 3 ? width <= 375 ? 'f-12 ' : 'f-12 ' : 'f-16 '}mt-2`}>{"$"}{numberOptimizeDecimal(numeral(data.market_data.total_value_locked.usd).format('0,0') !== 'NaN' ? numeral(data.market_data.total_value_locked.usd).format('0,0') : data.market_data.total_value_locked.usd.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}</div>
                              </Col>
                            )}
                          </Row>
                        </Col>
                          ...
                          <Card className="mb-0">
                            ...
                            <CardBody className="p-4" style={{ backgroundColor: 'rgba(0,0,0,.065)', borderRadius: '0 0 15px 15px' }}>
                              ...
                              <div className="d-flex align-items-center mt-3">
                                ...
                                <span className="text-right ml-auto">{data.market_data && data.market_data.current_price && typeof data.market_data.current_price[currency] === 'number' ? <>{currencyData && currencyData.symbol}{numberOptimizeDecimal(numeral(data.market_data.current_price[currency]).format('0,0.0000000000') !== 'NaN' ? numeral(data.market_data.current_price[currency]).format('0,0.0000000000') : data.market_data.current_price[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{!(currencyData && currencyData.symbol) && (<>&nbsp;{currency.toUpperCase()}</>)}</> : 'N/A'}</span>
                              </div>
                              <div className="d-flex align-items-center mt-3">
                              ...
                              <div className="d-flex align-items-center mt-3">
                                ...
                                <span className="text-right ml-auto">{data.market_data && data.market_data.total_volume && typeof data.market_data.total_volume[currency] === 'number' ? <>{currencyData && currencyData.symbol}{numberOptimizeDecimal(numeral(data.market_data.total_volume[currency]).format('0,0.0000000000') !== 'NaN' ? numeral(data.market_data.total_volume[currency]).format('0,0.0000000000') : data.market_data.total_volume[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{!(currencyData && currencyData.symbol) && (<>&nbsp;{currency.toUpperCase()}</>)}</> : 'N/A'}</span>
                              </div>
                              ...
                              <div className="d-flex align-items-center mt-3">
                                ...
                                <span className="text-right ml-auto">{data.market_data && data.market_data.fully_diluted_valuation && typeof data.market_data.fully_diluted_valuation[currency] === 'number' ? <>{currencyData && currencyData.symbol}{numberOptimizeDecimal(numeral(data.market_data.fully_diluted_valuation[currency]).format('0,0.0000000000') !== 'NaN' ? numeral(data.market_data.fully_diluted_valuation[currency]).format('0,0.0000000000') : data.market_data.fully_diluted_valuation[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{!(currencyData && currencyData.symbol) && (<>&nbsp;{currency.toUpperCase()}</>)}</> : '-'}</span>
                              </div>
                              <h3><p className="text-info mt-4 mb-0 pt-1">{data.name}{" Supply"}</p></h3>
                              <div className="d-flex align-items-center mt-3">
                                <span className="text-secondary mr-1">{"Circulating Supply"}</span>
                                <span className="text-right ml-auto">{data.market_data && typeof data.market_data.circulating_supply === 'number' && data.market_data.circulating_supply > 0 ? <>{numberOptimizeDecimal(numeral(data.market_data.circulating_supply).format('0,0') !== 'NaN' ? numeral(data.market_data.circulating_supply).format('0,0') : data.market_data.circulating_supply.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{data.symbol && (<>&nbsp;{data.symbol.toUpperCase()}</>)}</> : 'N/A'}</span>
                              </div>
                              <div className="d-flex align-items-center mt-3">
                                <span className="text-secondary mr-1">{"Total Supply"}</span>
                                <span className="text-right ml-auto">{data.market_data && typeof data.market_data.total_supply === 'number' ? <>{numberOptimizeDecimal(numeral(data.market_data.total_supply).format('0,0') !== 'NaN' ? numeral(data.market_data.total_supply).format('0,0') : data.market_data.total_supply.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{data.symbol && (<>&nbsp;{data.symbol.toUpperCase()}</>)}</> : '-'}</span>
                              </div>
                              <div className="d-flex align-items-center mt-3">
                                <span className="text-secondary mr-1">{"Max Supply"}</span>
                                <span className="text-right ml-auto">{data.market_data && typeof data.market_data.max_supply === 'number' ? <>{numberOptimizeDecimal(numeral(data.market_data.max_supply).format('0,0') !== 'NaN' ? numeral(data.market_data.max_supply).format('0,0') : data.market_data.max_supply.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{data.symbol && (<>&nbsp;{data.symbol.toUpperCase()}</>)}</> : '-'}</span>
                              </div>
                              ...
                              <div className="d-flex align-items-center mt-3">
                                ...
                                <span className="text-right ml-auto">{data.market_data && data.market_data.ath && typeof data.market_data.ath[currency] === 'number' ? <>{currencyData && currencyData.symbol}{numberOptimizeDecimal(numeral(data.market_data.ath[currency]).format('0,0.0000000000') !== 'NaN' ? numeral(data.market_data.ath[currency]).format('0,0.0000000000') : data.market_data.ath[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{!(currencyData && currencyData.symbol) && (<>&nbsp;{currency.toUpperCase()}</>)}</> : 'N/A'}</span>
                              </div>
                              <div className="d-flex align-items-center">
                              ...
                              <div className="d-flex align-items-center mt-3">
                                ...
                                <span className="text-right ml-auto">{data.market_data && data.market_data.atl && typeof data.market_data.atl[currency] === 'number' ? <>{currencyData && currencyData.symbol}{numberOptimizeDecimal(numeral(data.market_data.atl[currency]).format('0,0.0000000000') !== 'NaN' ? numeral(data.market_data.atl[currency]).format('0,0.0000000000') : data.market_data.atl[currency].toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{!(currencyData && currencyData.symbol) && (<>&nbsp;{currency.toUpperCase()}</>)}</> : 'N/A'}</span>
                              </div>
                              <div className="d-flex align-items-center">
                              ...
                              {data.market_data && data.market_data.roi && (
                                <>
                                  <div className="d-flex align-items-center mt-3">
                                    ...
                                    <span className="text-right ml-auto">{typeof data.market_data.roi.times === 'number' ? <>{numberOptimizeDecimal(numeral(data.market_data.roi.times).format('0,0.00') !== 'NaN' ? numeral(data.market_data.roi.times).format('0,0.00') : data.market_data.roi.times.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{"x"}</> : 'N/A'}</span>
                                  </div>
                                  <div className="d-flex align-items-center">
                                    ...
                                    {_.orderBy(tickers.map((ticker, i) => {
                                      ...
                                      <tr key={i}>
                                        ...
                                        <td className={`text-right ${marketSort.field === `converted_volume.${currencyMarket}` ? 'bg-light' : ''}`}>
                                          ...
                                          {ticker.target && currencyMarket && ticker.target.toLowerCase() !== currencyMarket.toLowerCase() && typeof ticker.volume === 'number' && (<div className="f-10 text-info">{numberOptimizeDecimal(numeral(ticker.volume * ticker.last).format(ticker.volume * ticker.last > 1 ? '0,0' : '0,0.0000000000') !== 'NaN' ? numeral(ticker.volume * ticker.last).format(ticker.volume * ticker.last > 1 ? '0,0' : '0,0.0000000000') : (ticker.volume * ticker.last).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 10 }))}{ticker.target && (<>&nbsp;{ticker.target.startsWith('0X') && ticker.target_coin_id && allCryptoData && allCryptoData.coins && allCryptoData.coins.findIndex(c => c.id === ticker.target_coin_id) > -1 ? allCryptoData.coins[allCryptoData.coins.findIndex(c => c.id === ticker.target_coin_id)].name : ticker.target.toUpperCase()}</>)}</div>)}
                                        </td>
